        ...
        <div className="flex flex-col w-full min-h-screen justify-center items-center bg-gradient-to-b from-gray-50 to-white p-4">
            <main className="flex flex-col w-full max-w-md mx-auto h-auto min-h-[600px] shadow-xl border border-gray-200 px-8 py-10 gap-6 rounded-2xl items-center bg-white">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <h1 className="text-3xl font-bold bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 bg-clip-text text-transparent">Join Us</h1>
                </div>
                ...
                <p className="text-center text-xs text-gray-500 leading-relaxed">
                    ...
                    <Link to={""} className="text-blue-600 hover:text-blue-700 cursor-pointer font-medium transition-colors duration-200">
                        Terms of Service
                    </Link>{" "}
                    and{" "}
                    <Link to={""} className="text-blue-600 hover:text-blue-700 cursor-pointer font-medium transition-colors duration-200">
                ...
                <p className="text-center text-sm text-gray-600">
                    ...
                    >
                        <Link to="/sign-in" onClick={() => {handleClick()}} className="text-blue-600 hover:text-blue-700 underline cursor-pointer font-medium transition-colors duration-200">
                            Sign in
                        </Link>
                    </span>
                    </p>
